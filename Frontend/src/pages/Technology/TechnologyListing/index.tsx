...
import { getTechnologyData } from 'services/technologyService';
import { IconChevronRight } from '@tabler/icons';
import Breadcrumbs from 'ui-component/extended/Breadcrumbs';
// import { AdminManage } from 'components/AdminManage';

const TechnologyListing = (props: any) => {
        ...
        },
        {
            ...
            render: ({ data }: { data: any }) => {
                return (
                    <Grid>
                        <Grid>
                            <Link to={'/technology/create?uuid=' + data?.uuid}>
    ...
    return (
        <>
            <Breadcrumbs separator={IconChevronRight} heading={'List of Technologies'} icon title rightAlign />
            <SubCard>
                <DataGridOData
                    // showAddButton={true}
                    dataResolver={getTechnologyData} // api function
                    // exportCSV={exportCSV}
                    keyName="id"
