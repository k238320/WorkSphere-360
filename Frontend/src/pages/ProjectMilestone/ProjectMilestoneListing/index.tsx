...
import { getMilestonePhase } from 'services/projectService';
import { IconChevronRight } from '@tabler/icons';
import Breadcrumbs from 'ui-component/extended/Breadcrumbs';
// import { AdminManage } from 'components/AdminManage';

const ProjectMilestoneListing = (props: any) => {
        ...
        },
        {
            ...
            render: ({ data }: { data: any }) => {
                return (
                    <Grid>
                        <Grid>
                            <Link to={'/milestone/create?uuid=' + data?.uuid}>
    ...
    return (
        <>
            <Breadcrumbs separator={IconChevronRight} heading={'List of Milestones'} icon title rightAlign />
            <SubCard>
                <DataGridOData
                    // showAddButton={true}
                    dataResolver={getMilestonePhase} // api function
                    // exportCSV={exportCSV}
                    keyName="id"
...
export default ProjectMilestoneListing;
