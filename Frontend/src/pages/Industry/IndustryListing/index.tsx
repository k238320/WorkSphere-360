...
import { getProjectIndustry } from 'services/industryService';
import { IconChevronRight } from '@tabler/icons';
import Breadcrumbs from 'ui-component/extended/Breadcrumbs';
// import { AdminManage } from 'components/AdminManage';

const IndustryListing = (props: any) => {
        ...
        },
        {
            ...
            render: ({ data }: { data: any }) => {
                return (
                    <Grid>
                        <Grid>
                            <Link to={'/industry/create?uuid=' + data?.uuid}>
    ...
    return (
        <>
            <Breadcrumbs separator={IconChevronRight} heading={'List of Industries'} icon title rightAlign />
            <SubCard>
                <DataGridOData
                    // showAddButton={true}
                    dataResolver={getProjectIndustry} // api function
                    // exportCSV={exportCSV}
                    keyName="id"
