...
const AssetCategoryListing = (props: any) => {
        ...
        // },
        {
            ...
            render: ({ data }: { data: any }) => {
                return (
                    <Grid>
                        <Grid>
                            <Link to={'/asset-category/create?uuid=' + data?.uuid}>
    ...
    return (
        <>
            <Breadcrumbs separator={IconChevronRight} heading={'List of Asset Categories'} icon title rightAlign />
            <SubCard>
                <DataGridOData
                    dataResolver={getAssetCategoryListing} // api function
                    keyName="id"
...
export default AssetCategoryListing;
