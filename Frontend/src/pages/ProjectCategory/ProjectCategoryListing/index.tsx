...
import { getProjectCategoryData } from 'services/categoryService';
import { IconChevronRight } from '@tabler/icons';
import Breadcrumbs from 'ui-component/extended/Breadcrumbs';
// import { AdminManage } from 'components/AdminManage';

const ProjectCategoryListing = (props: any) => {
        ...
        },
        {
            ...
            render: ({ data }: { data: any }) => {
                return (
                    <Grid>
                        <Grid>
                            <Link to={'/category/create?uuid=' + data?.uuid}>
    ...
    return (
        <>
            <Breadcrumbs separator={IconChevronRight} heading={'List of Category'} icon title rightAlign />
            <SubCard>
                <DataGridOData
                    // showAddButton={true}
                    dataResolver={getProjectCategoryData} // api function
                    // exportCSV={exportCSV}
                    keyName="id"
