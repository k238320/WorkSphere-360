...
// assets
import { IconBell, IconLogout, IconSearch, IconSettings, IconUser } from '@tabler/icons';
...
const ProfileSection = () => {
    ...
    return (
        <>
            <Typography className="header__user__name">{user?.name}</Typography>
            <NotificationDropDown notifications={notificationData || []} GetNotifications={GetNotifications} />
            <Chip
                sx={{
                    height: '48px',
                    alignItems: 'center',
