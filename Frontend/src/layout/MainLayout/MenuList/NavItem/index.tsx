...
const NavItem = ({ item, level, parentId }: NavItemProps) => {
    ...
    const isSelected = selectedItem.findIndex((id: any) => id === item.id) > -1;
    ...
    const itemIcon = item?.icon ? (
        ...
        <FiberManualRecordIcon
            sx={{
                ...
                width: selectedItem.findIndex((id: any) => id === item?.id) > -1 ? 8 : 6,
                height: selectedItem.findIndex((id: any) => id === item?.id) > -1 ? 8 : 6
            }}
