...
export const DropzoneImgComponent = (props: Props) => {
    ...
    const customAccept: Accept = {
        ...
        image: ['image/*'] // Allow all types of image files
    };
    ...
    return (
        <Grid container rowSpacing={1} justifyContent={'space-between'}>
            <div className={classes.baseStyle} {...getRootProps({ isFocused, isDragAccept, isDragReject })}>
                <input {...getInputProps()} type="file" id="pdfFile" name="pdfFile" accept=".pdf, image/*" />
                {props?.message ? (
