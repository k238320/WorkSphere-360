...
export function IndustryManage(props: any) {
    ...
    const getIndustryDataByID = async () => {
        dispatch(spinLoaderShow(true));
        getProjectIndustryByID(uuid)
            .then((res: any) => {
                setApiData(res);
