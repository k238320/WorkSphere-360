...
import { createProjectStatus, getProjectStatusByID, updateProjectStatus } from 'services/status';

export function StatusManage(props: any) {
    ...
    const getProjectStatusDataByID = async () => {
        dispatch(spinLoaderShow(true));
        getProjectStatusByID(uuid)
            .then((res: any) => {
                setApiData(res);
