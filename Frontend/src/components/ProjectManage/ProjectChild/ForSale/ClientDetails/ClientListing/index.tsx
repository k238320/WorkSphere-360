...
export default function ClientListing(props: any) {
    ...
    const { clientDetails, setClientDetails, projectId } = props;
    ...
    const deteleButton = (index: number) => {
        const updatedClientDetails: any = JSON.parse(JSON.stringify(tableData));

        if (projectId && !updatedClientDetails[index].is_add) {
            updatedClientDetails[index].is_delete = true;
        } else {
        ...
        setTableData(updatedClientDetails);
    };
