...
import { createTaskCategory, getTaskCategoryById, updateTaskCategory } from 'services/taskCategoryService';

export function TaskCategoryManage(props: any) {
    ...
    const getTaskCategoryByIdData = async () => {
        dispatch(spinLoaderShow(true));
        getTaskCategoryById(uuid)
            .then((res: any) => {
                setApiData(res);
    ...
    const createonSubmit = (data: any) => {
        ...
        createTaskCategory(data)
            .then((res: any) => {
                ...
                dispatch(spinLoaderShow(false));
                navigate('/task-category/listing');
            })
            .catch((err: any) => {
                dispatch(spinLoaderShow(false));
                toast.error(err);
