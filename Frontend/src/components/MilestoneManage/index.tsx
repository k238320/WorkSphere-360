...
import { createMilestonePhase, getMilestonePhaseByID, updateMilestonePhase } from 'services/projectService';

export function MilestoneManage(props: any) {
    ...
    const getMilestoneDataByID = async () => {
        dispatch(spinLoaderShow(true));
        getMilestonePhaseByID(uuid)
            .then((res: any) => {
                setApiData(res);
